    ...
    var writeEditor = new Vue({
        ...
        mounted(){
          tinymce.init({
            ...
            toolbar1:'bold italic forecolor backcolor | heading blockquote codesample numlist bullist | link b2imagelibrary b2video hr | insertShotCode | removeformat | code | fullscreen',
            image_caption: true,
